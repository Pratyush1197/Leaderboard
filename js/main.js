...
$(document).ready(function(){
    ...
    for(j = 0; j<=data.length-1; j++){
        if(data[j].repo == 'Rocket.Chat.Android'){
        var username = data[j].title;
        $("#tab1_android").append("<tr><td>"+username+"</td><tr>")

 
    $.ajax({
        url:'https://api.github.com/repos/'+ username +'/Rocket.Chat.Android/events',
       ...
       $("#tab2_android").append("<tr><td>"+count+"</td></tr>")
});
    }   
