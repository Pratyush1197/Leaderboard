...
$(document).ready(function(){
    ...
    for(j = 0; j<=data.length-1; j++){
        if(data[j].repo == 'Rocket.Chat.ReactNative'){
        var username = data[j].title;
        $("#tab1_react").append("<tr><td>"+username+"</td><tr>")

 
    $.ajax({
        url:'https://api.github.com/repos/'+ username +'/Rocket.Chat.ReactNative/events',
       ...
       $("#tab2_react").append("<tr><td>"+count+"</td></tr>")
});
    }   
