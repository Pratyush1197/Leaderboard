...
$(document).ready(function(){
    ...
    for(j = 0; j<=data.length-1; j++){
        if(data[j].repo == 'Rocket.Chat.iOS'){
        var username = data[j].title;
        $("#tab1_ios").append("<tr><td>"+username+"</td><tr>")

 
    $.ajax({
        url:'https://api.github.com/repos/'+ username +'/Rocket.Chat.iOS/events',
       ...
       $("#tab2_ios").append("<tr><td>"+count+"</td></tr>")
});
    }   
